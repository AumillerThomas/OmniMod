...
namespace OmniMod.Tiles{
	...
	public class OmniOrePass : GenPass
	{
		public OmniOrePass(string name, float loadWeight) : base(name, loadWeight) {
		}
		...
		protected override void ApplyPass(GenerationProgress progress, GameConfiguration configuration) {
			...
			progress.Message = OmniOreSystem.OmniOrePassMessage.Value;
			...
			for (int k = 0; k < (int)(Main.maxTilesX * Main.maxTilesY * 6E-05); k++) {
				...
				WorldGen.TileRunner(x, y, WorldGen.genRand.Next(3, 6), WorldGen.genRand.Next(2, 6), ModContent.TileType<OmniOre>());
