...
namespace OmniMod.Items.Projectiles{
    ...
    public class StoepsisYoYoProjectile : ModProjectile{
		...
		public override void SetStaticDefaults() {
			...
			ProjectileID.Sets.YoyosLifeTimeMultiplier[Projectile.type] = 25.5f;
		...
		public override void SetDefaults() {
			Projectile.width = 32; // The width of the projectile's hitbox.
			Projectile.height = 32; // The height of the projectile's hitbox.
